...
class JournalOfferForm(forms.ModelForm):
    ...
    def __init__(self, data=None, files=None, auto_id='id_%s', prefix=None, initial=None, error_class=ErrorList,
        ...
        if instance:
            initial.update({
                'journal_bundle': instance.condition.journal_bundle_uuid,
    ...
    def save(self, commit=True):
        ...
        if commit:
            ...
            if hasattr(self.instance, 'condition'):
                ...
                self.instance.condition = create_condition(JournalBundleCondition, journal_bundle_uuid=journal_bundle_uuid)
